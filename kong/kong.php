...
<body>
    ...
    <nav>
      <div class="navbar">
		...
		<article>
		<div class=IMG>
<img id="image1" src="../kong/kong.JPEG" onclick="changeImage();speakText();"/>
<p id="text"></p>
</div>
<script>
  var images = ["../kong/kong.JPEG", "../kong/kong1.JPEG", "../kong/kong.JPEG", "../kong/kong3.JPEG", "../kong/kong.JPEG", "../kong/kong4.JPG", "../kong/kong.JPEG"];
  ...
  function changeImage() {
   ...
   function speakText() {
    ...
    window.speechSynthesis.speak(utterance);
		...
		<main class=second>
			<a href="../toy/toy.php"class="left">Back Page</a>	
		<a href="../rope/rope.php"class="right">Next Page</a>
		</main>

    ...
    <nav>
      <div class="navbar">
        ...
        <li><a href="../navigation/setting.php"><li>Settings</li></a>
		 <li><a href="../navigation/logout.php"><li>Logout</li></a>
	 </div>
        </div>
      </div>
    </nav>
		<main>
		<h2>Lexigrams Albums</h2>
		</main>
		<article>
		...
		<div class="box">
			...
			<a href="../settings/thing.php"><h3>Things</h3></a>
		</div>
		</div>
		<div class="box">
			<div class="content">
			<img src= "../images/feel.JPG">
			<a href="../settings/feeling.php"><h3>Feelings</h3></a>
		</div>
		</div>
		<div class="box">
			<div class="content">
			<img src= "../images/action.JPG">
			<a href="../settings/action.php"><h3>Actions</h3></a>
		</div>
		</div>
		<div class="box">
			<div class="content">
			<img src= "../images/place.JPG">
			<a href="../settings/place.php"><h3>Places</h3></a>
		</div>
		</div>
		</div>
		</div>
		...
		<main class=second>
			<a href="../settings/lexigramoption.php"class=left>Back Page</a>
		</main>

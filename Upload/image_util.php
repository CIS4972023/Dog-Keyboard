...
function process_image($dir, $filename) {
	...
	$image_path_600 = $dir . $image_name . '_600' . $ext;
    //$image_path_400 = $dir . $image_name . '_400' . $ext;
    //$image_path_250 = $dir . $image_name . '_250' . $ext;
    //$image_path_100 = $dir . $image_name . '_100' . $ext;

//Want to use an image of this size only
resize_image($image_path, $image_path_600, 600, 500);
...
function resize_image($old_image_path, $new_image_path,
	...
	//WE CAN CHOOSE WHICH FILES WE DON'T WANT TO BE ADDED HERE.
	//SO FAR ONLY JPG WILL WORK.
    switch($image_type) {
        case IMAGETYPE_JPEG:

...
<body>
    ...
    <nav>
      <div class="navbar">
		...
		<article>
		<div class=IMG>
<img id="image1" src="../dogpark/dogpark.JPEG" onclick="changeImage();speakText();"/>
<p id="text"></p>
</div>
<script>
  var images = ["../dogpark/dogpark.JPEG", "../dogpark/dogpark1.JPEG", "../dogpark/dogpark.JPEG"
  , "../dogpark/dogpark2.JPEG", "../dogpark/dogpark.JPEG", "../dogpark/dogpark3.JPEG"
  , "../dogpark/dogpark.JPEG", "../dogpark/dogpark4.JPEG", "../dogpark/dogpark.JPEG"];
  ...
  function changeImage() {
   ...
   function speakText() {
    ...
    window.speechSynthesis.speak(utterance);
			...
			<main class=second>
		<a href="../crate/crate.php"class="left">Back Page</a>	
		<a href="../inside/inside.php"class="right">Next Page</a>
		</main>	
</body>
<footer>
